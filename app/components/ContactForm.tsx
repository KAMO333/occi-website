...
export default function ContactForm() {
  ...
  return (
    <section id="contact-form" className="py-28 bg-[#0d0d0d] border-y border-white/8">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <div className="mb-4 flex items-center gap-3">
              ...
              <span className="text-orange-400 text-xs tracking-widest uppercase font-medium">Get In Touch</span>
            </div>
