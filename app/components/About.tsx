    ...
    <section id="about" className="py-28 bg-[#0d0d0d] border-y border-white/8">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        <FadeIn>
          ...
          <p className="text-white/50 leading-relaxed mb-8">Our vision is to become a <span className="text-orange-400">leading cabling brand in South Africa</span> — reputable, reliable, and professional in everything we do.</p>
